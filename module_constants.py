...
## Tocan+ ##  
# slot_center_sacerdote       	  = 101 #add for cleric
slot_center_tavern_itemseller     = 102
slot_center_tavern_trooprecruiter = 103
## Tocan- ## 
...
slot_center_has_guild			 = 137 #town
slot_center_has_university 		 = 138 #town
slot_center_has_blacksmith		 = 139 #town, castle
...
slot_center_player_enterprise     				  = 235 #noted with the item produced
slot_center_player_enterprise_production_order    = 236
slot_center_player_enterprise_consumption_order   = 237 #not used
slot_center_player_enterprise_days_until_complete = 237 #Used instead

slot_center_player_enterprise_balance             = 238 #not used
slot_center_player_enterprise_input_price         = 239 #not used
slot_center_player_enterprise_output_price        = 241 #not used
## Tocan- ##
...
spt_merchant_caravan   		= 14 ## Tocan ## Sea Trader
...
hero_escape_after_defeat_chance = 60 ## Tocan ## Test 60
...
## Tocan+ ##   
tavern_trooprecruiters_begin = "trp_tavern_trooprecruiter_1"
tavern_trooprecruiters_end = tavern_travelers_begin

ransom_brokers_begin = "trp_ransom_broker_1"
ransom_brokers_end   = tavern_trooprecruiters_begin
## Tocan- ##  
...
slot_town_is_coastal = slot_party_follow_me #63  (any other new or unused slot can ofc be used as well) ## Tocan ## Seatrade 
## Tocan- ##
...
arena_tier1_prize = 10 ## Tocan ## amount doubled
arena_tier2_opponents_to_beat = 6
arena_tier2_prize = 20 ## Tocan ## amount doubled
arena_tier3_opponents_to_beat = 10
arena_tier3_prize = 50 ## Tocan ## amount doubled
arena_tier4_opponents_to_beat = 20
arena_tier4_prize = 120 ## Tocan ## amount doubled
arena_grand_prize = 500 ## Tocan ## amount doubled
...
TC_VERSION_STRING = "1.6 Beta (March 3, 2013)" ## last was 1.5 Beta (Febr 17, 2013) ## Tocan ##  
...
slot_troop_duel_won	  = 166	#duel mod - how many duels player won against this troop
slot_troop_duel_lost	  = 167	#duel mod - how many duels player lost against this troop
slot_troop_duel_started	  = 168	#duel mod - if player started dueling with this troop

# Duel mod constants
king_renown_for_duel = 200	# Minimum renown needed to challenge a king to a friendly duel
lord_renown_for_duel = 100	# Minimum renown needed to challenge a king to a friendly duel

# slot_prisoner_agreed = 291 ## Tocan   Prisoner Chat

# Custom Troops begin
customizable_troops_begin="trp_custom_peasant"
customizable_troops_end="trp_custom_troops_end"
# Custom  Troops end

#LAZERAS MODIFIED  {Top Tier Troops Recruit}
additional_heroes_begin = "trp_swadian_hero1"
...
slot_finance_items                = 0 ## Tocan Blacksmith
## Tocan- ##
