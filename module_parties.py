...
###############################################################  
#  ("zendar","Ruins of Zendar",icon_village_snow_burnt_a|pf_is_static|pf_always_visible|pf_hide_defenders, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(18,60),[], 240), ## Tocan Zendar ##
  ...
  # ("town_23","Outpost",icon_outpost|pf_disabled|pf_town|pf_is_static, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(0, 0),[]),

#  ("town_23","Zendar", pf_disabled|icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(18,60),[], 170), ## Tocan Zendar
...
# Tuavus   Pamir   vezona 
  ...
  ("salt_mine","Salt_Mine",icon_bandit_lair|pf_is_static|pf_always_visible|pf_hide_defenders, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(14.2, -31),[]),
...
#  ("black_khergit_spawn_point"  ,"black_khergit_sp",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(47.1, -73.3),[(trp_looter,15,0)]),
  ...
  ## Tocan  
  ("braganca_spawn"   ,"Braganca's Bandits",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(-93.6, -53.6),[(trp_looter,15,0)]),
  ("usiatra_spawn"   ,"Usiatra's Bandits",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(47.3, -25.9),[(trp_looter,15,0)]),
  ("sverre_spawn"   ,"Sverre's Bandits",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(-71.1,88.4),[(trp_looter,15,0)]),
  ("aethrod_spawn"   ,"Aethrod's Bandits",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(78, 84),[(trp_looter,15,0)]),
  ("zaira_spawn"   ,"Zaira's Bandits",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(130.3, -101.8),[(trp_looter,15,0)]),
  
  ("hegen_spawn"   ,"Hegen's Warband",pf_disabled|pf_is_static, no_menu, pt_none, fac_manhunters,0,ai_bhvr_hold,0,(-36.6, -13.2),[(trp_looter,15,0)]),
  ("konrad_spawn"   ,"Konrad's Warband",pf_disabled|pf_is_static, no_menu, pt_none, fac_manhunters,0,ai_bhvr_hold,0,(17.4, 100.7),[(trp_looter,15,0)]),
  ("borislav_spawn"   ,"Borislav's Warband",pf_disabled|pf_is_static, no_menu, pt_none, fac_manhunters,0,ai_bhvr_hold,0,(60.5, 68.2),[(trp_looter,15,0)]),
  ("stavros_spawn"   ,"Stavros Warband",pf_disabled|pf_is_static, no_menu, pt_none, fac_manhunters,0,ai_bhvr_hold,0,(18,60),[(trp_looter,15,0)]),
  ("gamara_spawn"   ,"Gamara Warband",pf_disabled|pf_is_static, no_menu, pt_none, fac_manhunters,0,ai_bhvr_hold,0,(47.1, -73.3),[(trp_looter,15,0)]),
  
  ("tang_spawn"   ,"Miura Tang's Bandits",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(149, 25),[(trp_looter,15,0)]),
...
#Wulf Tocan
 ("ship_raider_spawn_point_1"   ,"the_ocean",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(-53.4429,108.96),[(trp_looter,15,0)]), #Sea Raiders
 ("ship_raider_spawn_point_2"   ,"the_ocean",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(-93.9,-116.3),[(trp_looter,15,0)]), #Sea Raiders
 ("ship_raider_spawn_point_3"   ,"the_ocean",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(-147.282,109.899),[(trp_looter,15,0)]), #Pirates
#Wulf Tocan
