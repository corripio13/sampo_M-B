...
("faction_troop_tree", 0, mesh_load_window,
 [(ti_on_presentation_load,
  [(presentation_set_duration, 999999),
   ...
   # Objects
   (assign, ":hi_faction", "fac_kingdoms_end"), ## Tocan Invasion  fac_kingdoms_end 
   (assign, ":lo_faction", "fac_kingdom_1"), ## Tocan : Custom Troops should not be displayed   
## Tocan : Custom Troops should not be displayed   
   (try_begin),
   ...
   (try_for_range, ":faction", ":lo_faction", ":hi_faction"),
	(neq, ":faction", "fac_dark_knights"), ## Tocan Invasion   
	(neq, ":lo_faction", "fac_dark_knights"),
	(neq, ":hi_faction", "fac_dark_knights"),
